...
def main(args):
    ...
    results = f"det_outputs/{args.run_name}_{args.dataset}_collectstep{args.collect_step}_infsteps{args.num_inference_steps}.jsonl"
    os.makedirs(os.path.dirname(results), exist_ok=True)
    write_jsonlines(all_tracks, filename=results)
